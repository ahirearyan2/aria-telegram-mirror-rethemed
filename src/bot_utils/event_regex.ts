...
export class EventRegex {
  ...
  constructor() {
    // var commands = ['^[/|.]start', '^[/|.](tarmirror|mt)', '^[/|.](mirror|m)', '^[/|.](status|ms)', '^[/|.](list|l)', '^[/|.](getfolder|gf)', '^[/|.](cancel|cm)', '^[/|.](cancelall|ca)', '^[/|.](stats)', '^[/|.](getlink|gl)', '^[/|.](clone|c)', '^[/|.]id', '^[/|.]mf', '^[/|.](tar|t)', '^[/|.](unzipmirror|um)', '^[/|.](count|cnt)', '^[/|.](help|h)', '^[/|.](authorize|a)', '^[/|.](unauthorize|ua)'];
